...
prompt_file_path = r"C:\Users\HP\Downloads\Shoezapfinale\Gemini-Bot\check.txt"  # Path to your check.txt file
prompt = get_prompt_from_file(prompt_file_path)

# Load images from the 'shoes' folder
shoe_folder = r"C:\Users\HP\Downloads\Shoezapfinale\shoes"  # Change this to your local path
shoe_image_paths = load_images_from_folder(shoe_folder)

# Specify the path for features.pt
features_path = r"C:\Users\HP\Downloads\Shoezapfinale\features.pt"
