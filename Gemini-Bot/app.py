...
UPLOAD_FOLDER = r'C:\Users\HP\Downloads\Shoezapfinale\Gemini-Bot\static'
...
def run_script():
    script_path = r'C:\Users\HP\Downloads\Shoezapfinale\Gemini-Bot\text2image.py'
    try:
        # Run the script
...
def virtual_try_on():
    script_path = r'C:\Users\HP\Downloads\Shoezapfinale\Gemini-Bot\Virtualtrypa.py'
    try:
        # Run the script
        subprocess.run(['python', script_path], check=True)
        return jsonify({'status': 'success'}), 200
